...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\BeeperPS\functions", "$global:testroot\..\BeeperPS\internal\functions"),
...
$CommandPath = @(
    "$global:testroot\..\BeeperPS\functions"
    "$global:testroot\..\BeeperPS\internal\functions"
)
